package org.SSheng.CytoGRN.internal.algorithm.pca_pmi;
			...
			Thread processThread = new Thread(new Runnable() {
				public void run() {
					try {
						...
						if (Pca_pmiConfigPanel.this.cbAmount.getState()
								&& (!Pca_pmiConfigPanel.this.cbThreshold.getState())) {
						...
						}else if (Pca_pmiConfigPanel.this.cbThreshold.getState()
								&& (!Pca_pmiConfigPanel.this.cbAmount.getState())) {
