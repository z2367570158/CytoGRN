package org.SSheng.CytoGRN.internal.algorithm.CN;
...
public class CNConfigPanel extends JPanel {
	...
	public CNConfigPanel(MyControlPanel mycontrolpanel, CyNetworkFactory networkFactory,
		...
		tflamda.setSize(new Dimension(120, 20));
		...
		labelAlgorithmThreshold.setLocation(10, 330);

		tfAlgorithmThreshold = new JTextField();
		tfAlgorithmThreshold.setSize(new Dimension(45, 20));
		tfAlgorithmThreshold.setLocation(80, 335);
		tfAlgorithmThreshold.setHorizontalAlignment(JTextField.CENTER);
		tfAlgorithmThreshold.setText("0.5485");
		tfAlgorithmThreshold.addKeyListener(new DoubleRestrictAdapter());
